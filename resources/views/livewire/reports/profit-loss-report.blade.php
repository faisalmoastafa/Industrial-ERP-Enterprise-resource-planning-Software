    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-4">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        <div class="text-value text-primary">{{ format_currency($other_income_amount) }}</div>
                        <div class="text-uppercase font-weight-bold small">Other Income</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-lg-4">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    <div class="bg-primary p-3 mfe-3 rounded">
                        <i class="bi bi-person-vcard font-2xl"></i>
                    </div>
                    <div>
                        <div class="text-value text-primary">{{ format_currency($payroll_expenses_amount) }}</div>
                        <div class="text-uppercase font-weight-bold small">Payroll Expenses</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-lg-4">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    <div class="bg-primary p-3 mfe-3 rounded">
                        <i class="bi bi-arrow-up-right-circle font-2xl"></i>
                    </div>
                    <div>
                        <div class="text-value text-primary">{{ format_currency($net_payable_amount) }}</div>
                        <div class="text-uppercase font-weight-bold small">Net Payable</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-lg-4">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    <div class="bg-primary p-3 mfe-3 rounded">
                        <i class="bi bi-arrow-down-left-circle font-2xl"></i>
                    </div>
                    <div>
                        <div class="text-value text-primary">{{ format_currency($net_receivable_amount) }}</div>
                        <div class="text-uppercase font-weight-bold small">Net Receivable</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-lg-4">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    <div class="bg-primary p-3 mfe-3 rounded">
                        <i class="bi bi-tools font-2xl"></i>
                    </div>
                    <div>
                        <div class="text-value text-primary">{{ format_currency($conversion_cost_amount) }}</div>
                        <div class="text-uppercase font-weight-bold small">Conversion Cost</div>
                    </div>
                </div>
            </div>
        </div>
