...
<button class="neci-sidebar-toggle d-none d-md-inline-flex" type="button" id="neciSidebarToggle" aria-label="Collapse sidebar" aria-pressed="false" title="Collapse sidebar">
    <span class="neci-sidebar-toggle__orbit" aria-hidden="true">
        <span class="neci-sidebar-toggle__dot"></span>
        <span class="neci-sidebar-toggle__dot"></span>
        <span class="neci-sidebar-toggle__dot"></span>
    </span>
</button>
...
<ul class="c-header-nav ml-auto mr-4">
    ...
    <li class="c-header-nav-item mr-3">
        <a class="btn btn-primary btn-pill {{ request()->routeIs('app.pos.index') ? 'disabled' : '' }}" href="{{ route('app.pos.index') }}">
            <i class="bi bi-cart mr-1"></i> Sales Terminal
        </a>
    </li>
    @endcan
    ...
    <li class="c-header-nav-item dropdown d-md-down-none mr-2">
        <a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
            <i class="bi bi-bell header-bell-icon" style="font-size: 20px;"></i>
            <span class="badge badge-pill badge-danger">
            @php
                $low_quantity_products = \Illuminate\Support\Facades\Cache::remember(
                    'header_low_stock_products',
                    60, // seconds
                    fn () => \Modules\Product\Entities\Product::select('id', 'product_quantity', 'product_stock_alert', 'product_code')
    ...
    <li class="c-header-nav-item dropdown">
     ...
     src="{{ optional(auth()->user())->getFirstMediaUrl('avatars') ?: asset('images/default.png') }}" alt="Profile Image">
            </div>
        ...
        <div class="dropdown-menu dropdown-menu-right pt-0">
            ...
            @can('access_activity_log')
                <a class="dropdown-item" href="{{ route('activity-log.index') }}">
                    <i class="mfe-2 bi bi-clock-history" style="font-size: 1.2rem;"></i> Activity Log
                </a>
            @endcan
