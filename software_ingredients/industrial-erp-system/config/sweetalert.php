...
return [
    ...
    */
    ...
    'customClass' => [
        ...
        'container' => env('SWEET_ALERT_CONTAINER_CLASS', 'neci-swal-container'),
        'popup' => env('SWEET_ALERT_POPUP_CLASS', 'neci-swal-popup'),
        'header' => env('SWEET_ALERT_HEADER_CLASS'),
        'title' => env('SWEET_ALERT_TITLE_CLASS', 'neci-swal-title'),
        'closeButton' => env('SWEET_ALERT_CLOSE_BUTTON_CLASS'),
        'icon' => env('SWEET_ALERT_ICON_CLASS', 'neci-swal-icon'),
        'image' => env('SWEET_ALERT_IMAGE_CLASS'),
        'content' => env('SWEET_ALERT_CONTENT_CLASS', 'neci-swal-text'),
        'input' => env('SWEET_ALERT_INPUT_CLASS'),
        'actions' => env('SWEET_ALERT_ACTIONS_CLASS', 'neci-swal-actions'),
        'confirmButton' => env('SWEET_ALERT_CONFIRM_BUTTON_CLASS', 'btn btn-primary neci-swal-btn neci-swal-btn-confirm'),
        'cancelButton' => env('SWEET_ALERT_CANCEL_BUTTON_CLASS', 'btn btn-light neci-swal-btn neci-swal-btn-cancel'),
