...
@section('content')
    <div class="container-fluid">
        @include('includes.neci-page-header', [
            'icon' => 'bi-shop',
            'title' => 'Edit Supplier',
            'subtitle' => 'Update supplier contact details and opening balance'
        ])
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="opening_balance" min="0" step="0.01" value="{{ old('opening_balance', $supplier->opening_balance) }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group d-flex justify-content-start mt-3 mb-0">
                                <button type="submit" class="btn btn-primary">Update Supplier <i class="bi bi-check"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
