...
@section('content')
    <div class="container-fluid">
        @include('includes.neci-page-header', [
            'icon' => 'bi-cash-coin',
            'title' => 'Edit Expense',
            'subtitle' => 'Update expense date, category, amount, and details'
        ])
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input id="amount" type="text" class="form-control" name="amount" required value="{{ $expense->amount }}" data-money data-money-prefix="{{ settings()->currency->symbol }}" data-money-thousands="{{ settings()->currency->thousand_separator }}" data-money-decimal="{{ settings()->currency->decimal_separator }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group d-flex justify-content-start mt-3 mb-0">
                                <button type="submit" class="btn btn-primary">Update Expense <i class="bi bi-check"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
