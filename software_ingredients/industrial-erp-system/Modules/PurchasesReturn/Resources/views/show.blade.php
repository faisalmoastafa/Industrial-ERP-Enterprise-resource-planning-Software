...
@section('content')
    <div class="container-fluid">
        @include('includes.neci-page-header', [
            ...
            'subtitle' => 'Review returned supplier purchase products, status, and totals'
        ])
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a target="_blank" class="btn btn-sm btn-secondary mfe-1 d-print-none" href="{{ route('purchase-returns.pdf', $purchase_return->id) }}">
