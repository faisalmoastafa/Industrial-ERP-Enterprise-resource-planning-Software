...
class ProductDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('product_type', function ($data) {
                return $data->isRawMaterial() ? 'Raw Material' : 'Finished Product';
            })
    ...
    public function query(Product $model)
    {
        return $model->newQuery()
            ->with('category')
            ->when(request()->routeIs('raw-materials.*'), fn ($query) => $query->rawMaterial())
            ->when(!request()->routeIs('raw-materials.*'), fn ($query) => $query->finished());
    }
