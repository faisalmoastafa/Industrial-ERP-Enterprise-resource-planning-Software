...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item"><a href="{{ $product->isRawMaterial() ? route('raw-materials.index') : route('products.index') }}">{{ $product->isRawMaterial() ? 'Raw Materials' : 'Products' }}</a></li>
...
@section('content')
    <div class="container-fluid mb-4">
        @include('includes.neci-page-header', [
            'icon' => $product->isRawMaterial() ? 'bi-building' : 'bi-box-seam',
            'title' => $product->isRawMaterial() ? 'Raw Material Details' : 'Product Details',
            'subtitle' => 'Review stock, barcode, and pricing details'
        ])
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped mb-0">
                                ...
                                <tr>
                                    <th>Type</th>
                                    <td>{{ $product->isRawMaterial() ? 'Raw Material' : 'Finished Product' }}</td>
                                </tr>
                                <tr>
                                    <th>Category</th>
