...
class UploadController extends Controller
{
    ...
    public function dropzoneUpload(Request $request) {
        $request->validate([
            'file' => 'required|file|mimes:png,jpeg,jpg,pdf|max:10240'
        ]);
    ...
    public function dropzoneDelete(Request $request) {
        ...
        if (str_contains($request->file_name, '/') || str_contains($request->file_name, '\\')) {
            return response()->json('Invalid file name.', 422);
        }
