                    ...
                    <div class="card-body">
                        <form action="{{ route('profile.update') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <img style="width: 100px;height: 100px;" class="d-block mx-auto img-thumbnail img-fluid rounded-circle mb-2" src="{{ optional(auth()->user())->getFirstMediaUrl('avatars') ?: asset('images/default.png') }}" alt="Profile Image">
