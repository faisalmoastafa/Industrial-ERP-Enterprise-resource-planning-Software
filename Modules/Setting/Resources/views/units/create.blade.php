...
@section('content')
    <div class="container-fluid">
        @include('includes.neci-page-header', [
            'icon' => 'bi-calculator',
            'title' => 'Create Unit',
            'subtitle' => 'Add a measurement unit for stock and product quantities'
        ])
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="any" class="form-control" name="operation_value" placeholder="Enter a number">
                                    </div>
                                </div>
                                <div class="col-lg-12 d-flex justify-content-start">
                                    <div class="form-group">
                                        <button class="btn btn-primary">Create Unit <i class="bi bi-plus"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
