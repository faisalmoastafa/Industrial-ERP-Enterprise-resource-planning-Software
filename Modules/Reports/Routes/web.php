...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/payable-report', 'ReportsController@payableReport')
        ->name('payable-report.index');
    Route::get('/receivable-report', 'ReportsController@receivableReport')
        ->name('receivable-report.index');
    //Sales Report
