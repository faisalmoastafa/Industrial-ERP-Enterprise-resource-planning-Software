...
class SalesReturnController extends Controller
{
        ...
        DB::transaction(function () use ($request) {
            ...
            foreach (Cart::instance('sale_return')->content() as $cart_item) {
                ...
                if ($request->status == 'Completed') {
                    ...
                    $this->logStockChange('sale_return', $sale_return, $product, $cart_item->qty);
                }
            }
        ...
        DB::transaction(function () use ($request, $sale_return) {
            ...
            foreach ($sale_return->saleReturnDetails as $sale_return_detail) {
                if ($sale_return->status == 'Completed') {
                    ...
                    $this->logStockChange('sale_return_update_reversal', $sale_return, $product, -$sale_return_detail->quantity);
                }
            ...
            foreach (Cart::instance('sale_return')->content() as $cart_item) {
                ...
                if ($request->status == 'Completed') {
                    ...
                    $this->logStockChange('sale_return_update', $sale_return, $product, $cart_item->qty);
                }
            }
    ...
    private function logStockChange(string $source, SaleReturn $saleReturn, Product $product, $delta): void
    {
